...
using AI to generate insights not written in the reports to aid in policy decisions and negotiations. Externally, we were asked to do "something innovative". And this problem really *did* need innovation. To paint a simple
...
didn't point out that it had the same conditions of earthquake! *And*, this has to scale up.

Now, "you" are an LLM and you have to answer these questions to the most unforgiving users: `Policy Officers of 60+ 
...
In another rosy way, consider you only have 1 node per page for the reports at level Z (which is a bad idea), how
